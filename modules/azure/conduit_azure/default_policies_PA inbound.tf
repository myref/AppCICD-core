# Default policies are AD<-P, AD<-A, AD<-D, AD<-PA, AD<-AD, AD<-PAD
resource "azurerm_network_security_rule" "default_pa-with-p_in" {
...
resource "azurerm_network_security_rule" "default_pa-with-a_in" {
...
resource "azurerm_network_security_rule" "default_pa-with-d_in" {
